...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.completedTasks) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named completedTasks');
    }
      ...
      proveThreshold: async (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
          __compactRuntime.typeError('proveThreshold',
                                     ...
                                     'zeroshow.compact line 9 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
  ...
  _completedTasks_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.callContext.currentQueryContext.state), context.callContext.currentPrivateState, context.callContext.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.completedTasks(witnessContext_0);
    context.callContext.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('completedTasks',
                                 'return value',
  ...
  async _proveThreshold_0(context, partialProofData, threshold_0) {
    let t_0;
    const met_0 = (t_0 = this._completedTasks_0(context, partialProofData),
                   t_0 >= threshold_0);
    const tmp_0 = 1n;
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
...
const _dummyContract = new Contract({ completedTasks: (...args) => undefined });
export const pureCircuits = {};
export const contractReferenceLocations =
  { tag: 'publicLedgerArray', indices: { } };
export const expectedVk = {
  'proveThreshold': '6b51a40971b9d892e69245b97bea1ece5c2762221f0e7d76a9738ba2aeac3ea0',
};
